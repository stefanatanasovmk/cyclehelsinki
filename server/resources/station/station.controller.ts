...
export default class StationController implements Controller {
  ...
  private getAll = async (
    ...
    try {
      ...
      next(
        new HttpError(
          500,
          "We couldn't get all stations, please try again"
        )
      );
    }
  };
  ...
  private getOne = async (
    ...
    try {
      ...
      next(new HttpError(500, "We couldn't get the station, please try again"));
    }
  };

  //This route is not in use currently.
  //Controller for finding one Station in the db with given param as a ID and finding all the trips that departed and arrived at the station
  ...
  private getMostPopular = async (
    ...
    try {
      ...
      next(new HttpError(500, "We couldn't get the most popular stations, please try again"));
    }
  };
  ...
  private addStation = async (
    ...
    try {
      ...
      next(new HttpError(500, "We couldn't add the station, please try again"));
    }
  };
}
